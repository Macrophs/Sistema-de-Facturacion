      ...
      <tbody>
        {elements.map(({ code,date,client_cedula,client_name, total }) => (
          <tr key={code} className="bg-white border-b  hover:bg-gray-50 ">
            ...
            <td className="px-6 py-4">{client_cedula} <span className="text-black font-medium"> {client_name}</span></td>
            <td className="px-12 py-4"> <span className="text-green-600 font-medium"> ${total} </span></td>
