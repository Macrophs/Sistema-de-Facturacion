                ...
                <section className="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form className="block" action="pages/home_empleado.html" >
                        ...
                        <section className="relative">
                            ...
                            <button type="submit" className="text-black absolute right-2.5 bottom-2.5  hover:bg-gray-300 focus:ring-4 focus:outline-none  font-medium rounded-lg text-sm px-4 py-2 bg-gray-100 focus:ring-blue-800">Entrar</button>
                        </section>
                    </form>
                </section>
            </section>
