...
export async function GET(request) {
  ...
  const data = await client.query(
    `SELECT Users.id_user , Users.cedula , Users.name, Users.lastname, Users.email, Users.phone, rol.name as rol_name FROM "User" as Users INNER JOIN "Rol" as rol ON Users.id_rol = rol.id_rol and rol.name = 'employee' where active = true ${
